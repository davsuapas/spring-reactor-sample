...
/**
 * Relations between ente category property and ente category repository
 *
 * @author David Suárez
 */
public interface EnteCategoryPropertyRepository extends DependencyRelationRepository<EnteCategoryProperty, MapId> {
}
