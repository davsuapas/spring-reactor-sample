...
/**
 * Convert from/to cassandra dynamic object the string value
 * @see DataEngineValueConverter
 *
 * @author David Suárez
 */
public class DataEngineStringValueConverter implements DataEngineValueConverter {
    ...
    public DynamicObjectInstanceProperty.Value create(String value) {
        return new DynamicObjectInstanceProperty.StringValue(value);
    }
