...
/**
 * Relations between Ente category property and Ente category property or Ente
 *
 * @author David Suárez
 */
public interface EnteCategoryLinkPropertyRepository
        extends DependencyRelationRepository<EnteCategoryLinkProperty, MapId> {
}
